                ...
                <main className= "  bg-purple-200 flex  ">
                  ...
                  <div  >
                        ...
                        <form className= " my-0.5 flex flex-col"> 
                               ...
                               <input name="name"  type="text" placeholder="Enter Full Name" className= " px-3  my-0.5 rounded-xl h-9 font-bold w-96" />

                               <label forHtml="email" className= " my-0.5 text-slate-700 text-xl" >Email</label>
                               <input name="email"  type="email" placeholder="Enter email" className= " px-3 my-0.5 rounded-xl h-9 font-bold w-96" />

                               <label forHtml="password" className= " my-0.5 text-slate-700 text-xl" >Password</label>
                               <input name="password"  type="password" placeholder="Enter password" className= " px-3 my-0.5 rounded-xl h-9 font-bold w-96" />
